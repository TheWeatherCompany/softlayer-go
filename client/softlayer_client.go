...
func (slc *SoftLayerClient) GetSoftLayer_Location_Datacenter_Service() (softlayer.SoftLayer_Location_Datacenter_Service, error) {
...
func (slc *SoftLayerClient) initSoftLayerServices() {
	...
	slc.softLayerServices["SoftLayer_Location_Datacenter_Service"] = services.NewSoftLayer_Location_Datacenter_Service(slc)
}
